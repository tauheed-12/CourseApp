...
const App = () => {
  ...
  const [activateAddCourses, setActivateAddCourses] = useState(false)
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path='/login/admin' element={<SuperAdmin_login setActivateAddCourses={setActivateAddCourses} />}></Route>
        ...
        <Route
          path='/add_courses'
          element={activateAddCourses ? <AddCourses /> : <Navigate to="/login/admin" />}
        />
        <Route
          path={`/student/${LoggedId}`}
